        ...
        <main className="pt-20 pb-24">
          <section className="max-w-7xl lg:mx-auto md:mx-8 mx-5 lg:px-8 py-5">
            ...
            <div className="flex justify-center">
              <p className="text-[#94A3B8] lg:w-3/5 md:w-4/5 w-full text-center mt-5">
                The Neko NFT offers 1.2x multiplier for staking rewards. Staking
                your tokens along with your Neko NFT amplifies the ETH rewards
                you'll receive, generating significant passive income.
              </p>
            </div>
              ...
              <div>
                <div className="bg-[#10172a] rounded-md">
                  <div className="flex items-center justify-between py-4 px-6 border-b border-b-[#f1cf6f] border-opacity-10">
                    ...
                    <p className="bg-gray-500 text-white text-xs rounded-full py-[2px] px-2 font-medium">
                      0.4 ETH Each
                    </p>
                  </div>
                  <div className="px-6 pt-8 pb-4 grid md:grid-cols-2 grid-cols-1 gap-5">
                    ...
                    <div className="bg-[#192032] p-5 rounded-md">
                      ...
                      <p className="text-white font-semibold text-2xl mt-1">
                        <span className="text-[#3ECCB0] font-bold text-4xl">
                          0/
                        </span>
                        925
                      </p>
                  ...
                  <div className="flex items-center gap-5 px-6">
                    <button
                      onClick={handleMinus}
                      className="text-[#94a3b85d] border-2 border-[#3ECCB0] border-opacity-25 px-5 py-2 rounded-md hover:border-opacity-40 transition-all"
                    >
                      <AiOutlineMinus />
                    </button>
                    <input
